            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        <h5 class="fw-bold text-primary text-uppercase">Open Application</h5>
                        <h1 class="mb-0">INTERNSHIP APPLICATION 2023</h1>
                    </div>
                    <!-- <div class="row gx-3">
                    ...
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-dark w-100 py-3" type="submit">Process Application</button>
                                </div>
                            </div>
                        </form>
                    </div>
