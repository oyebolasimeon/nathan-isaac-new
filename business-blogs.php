            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="business-blogs.html" class="dropdown-item">Business</a>
                            <a href="finance-blogs.html" class="dropdown-item">Finance</a>
                            <a href="self-care-blogs.html" class="dropdown-item">Self Help</a>
                            <a href="faith-blogs.html" class="dropdown-item">Faith</a>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Business Blogs</h1>
                    <a href="" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Business Blogs</a>
                </div>
            </div>
        </div>
    </div>
