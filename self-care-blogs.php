        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Self Help Blogs</h1>
                    <a href="" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Self Help Blogs</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                 ...
                 <div class="col-lg-3 wow slideInUp" data-wow-delay="0.6s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            <img class="img-fluid" src="blog/self/peace.jpeg" alt="">
                        ...
                        <div class="p-4">
                            ...
                            <h4 class="mb-3">Peace & Prosperity</h4>
                            <p>I'm all set and I'm about to go into a dimension of shaking very serious ...</p>
               ...
               <div class="col-lg-3 wow slideInUp" data-wow-delay="0.9s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            <img class="img-fluid" src="blog/self/well-being.jpeg" alt="">
                        ...
                        <div class="p-4">
                            ...
                            <h4 class="mb-3">Wealth and Well-being</h4>
                            <p>Not everyone who is rich enjoys the fundamental benefit of being wealthy ...</p>
