                ...
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        <a href="index.html" class="navbar-brand">
                            <h1 class="m-0 text-white d-flex" style="font-size:25px;"><img src="assets/emblem.png" style="width: 50px;  margin-right:10px; height: 50px;" alt="" srcset=""> Get Free Newsletter <br>to grow your business <br> and personal finance</h1>
                        </a>
                        <p class="mt-3 mb-4">
                            Kindly enter your valid and email so as to be getting my weekly Newsletter
                        </p>
                        <form action="">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">Adetokunbo Ademola Street, Victoria Island, Lagos, Nigeria</p>
                            </div>
                            <div class="d-flex mb-2">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                ...
                                <a class="text-light mb-2" href="about.php"><i class="bi bi-arrow-right text-primary me-2"></i>About </a>
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                ...
                                <!-- <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Meet The Team</a> -->
                                <a class="text-light mb-2" href="internship.php"><i class="bi bi-arrow-right text-primary me-2"></i>Internship</a>
                                <a class="text-light" href="contact.php"><i class="bi bi-arrow-right text-primary me-2"></i>Contact</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">Nathan Isaac</a>. All Rights Reserved. 
						 ...
						 <a class="text-white border-bottom" href="https://oyebolasimeon.cloud">#</a></p>
                    </div>
                </div>
            </div>
        </div>
